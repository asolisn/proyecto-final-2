...
class Periodo:
    def_init_(self,periodo,descripcion):
...
class Profesor: 
    def_init_(self,id,nombre,cedula,carrera,titulo,telefono):
        self.__id = id
        self.nombre = nombre
        self.cedula = cedula
        self.titulo = titulo
...
class Estudiante: 
    def_init_(self,id,nombre,cedula,direccion,telefono):
        self.__id = id
        self.nombre = nombre
        self.cedula = cedula
...
class Matricula: 
    def_init_(self,id,estudiante,carrera,periodo,valor):
        self.__id = id
    ...
    def getMatricula(self):
        return  [str(self.id),self.periodo.periodo,str(self.estudiante.id),str(self.carrera.id),str(self.valor)]
   
class Notas: 
    def_init_(self,id,periodo,estudiante,materia,profesor,nota1,nota2):
        self.__id = id
        self.periodo = periodo
        self.estudiante = estudiante
...
class Cedula: 
    ...
    def getCedula(self):
        return  [str(self.id),self.cedula]